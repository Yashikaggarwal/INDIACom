    ...
    <div class="page-header-background">
        <div class="page-header-path">
            ...
            <a href="login.html" id="login-page">
                Track Incharge Review
            </a>
        </div>
        <div class="page-header-heading">
            <h1>TRACK INCHARGE REVIEW</h1>
        </div>
    </div>
...
<p>Copyright Transfer:
    <form action='render_pdf.php' method='post' target='_blank' style="display: inline;">
        ...
        <form method="POST">
            ...
            <option value="Rejected after Initial Review">Rejected after Initial Review</option>
            <option value="Revision Required based upon Initial Review">Revision Required based upon Initial Review</option>
            <option value="Sent for Detailed Review">Sent for Detailed Review</option>
            <option value="Rejected after Detailed Review">Rejected after Detailed Review</option>
            <option value="Minor Revisions Required based upon Detailed Review">Minor Revisions Required based upon Detailed Review</option>
            <option value="Major Revisions Required based upon Detailed Review">Major Revisions Required based upon Detailed Review</option>
            <option value="Accepted for Poster Session">Accepted for Poster Session</option>
            ...
            <label for="extra_page_count" style="font-size: 16px;">Extra Page Count: </label>
            <input type="text" id="extra_page_count" name="extra_page_count" style="width: 150px;">
            <br>
            ...
            <label for="compliance_report">Compliance Report to be filled by author (DOC / DOCX Format Only): </label>
            <input type="file" id="compliance_report" name="compliance_report" accept=".doc, .docx, .pdf" >
            <br><br>
