...
<body>
    ...
    <div class="container">
        ...
        <form id="retrieveMemberid" name="retrieveMemberid">
            <div id="divMessages"></div>
            <p>
                <label for="fp1">Email ID:</label><br>
                <input type="text" name="txtMemberID" size="50" id="fp1"></p>
            <p>
                <input type="submit" value="Retrieve Member Id" name="btnRetrieveMemberId">
            </p>
        </form>
        <p>
